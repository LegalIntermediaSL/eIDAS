...
El repositorio estaba practicamente vacio, con un `README.md` minimo y la licencia del proyecto.
...
- el idioma base del proyecto sera espanol
...
- sera importante validar en una siguiente fase las referencias normativas exactas
- convendra decidir si el tutorial sera puramente introductorio o si tambien incluira analisis juridico detallado
- puede ser util definir pronto una convencion de fuentes y bibliografia
