...
El formato se inspira en Keep a Changelog y se adapta a un proyecto de documentacion.

## [0.1.0] - 2026-04-16

### Added

- creacion del repositorio base para el tutorial sobre eIDAS
- redaccion inicial de `README.md` con objetivos, enfoque y estructura prevista
...
- actualizacion del `README.md` para incorporar navegacion entre la edicion en espanol y la edicion en ingles
